    ...
    return [
        {
            ...
            "semesters": CYCLE_MAPPING["sept-dec"],
            "months": "Septiembre - Diciembre"
        },
        {
            "id": "jan-apr",
            "name": CYCLE_NAMES["jan-apr"],
            "semesters": CYCLE_MAPPING["jan-apr"],
            "months": "Enero - Abril"
        },
        {
            "id": "may-aug",
            "name": CYCLE_NAMES["may-aug"],
            "semesters": CYCLE_MAPPING["may-aug"],
            "months": "Mayo - Agosto"
        }
    ]
...
def get_semester_name(semester):
    """Get display name for semester number"""
    ordinals = {
        1: "Primer", 2: "Segundo", 3: "Tercer", 4: "Cuarto", 5: "Quinto",
        6: "Sexto", 7: "Séptimo", 8: "Octavo", 9: "Noveno", 10: "Décimo"
    }
    return f"{ordinals.get(semester, str(semester))} Cuatrimestre"
